package ru.mirea.syomin.yandexmaps;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    private final String MAPKIT_API_KEY = "a28078fd-2845-4109-977c-7aaca92232b9";
    ...
    protected void onStart() {
        // Вызов onStart нужно передавать инстансом MapView и MapKit.
        super.onStart();
